    ...
    <div class="container">
        <div class="row align-items-center justify-content-between pt-5">
            ...
            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
                <div class="img-wrap">
                    <img src="<?php echo get_theme_file_uri("/images/img-1.jpg") ?>" alt="Image" class="img-fluid rounded">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-7 order-lg-2 mb-4 mb-lg-0">
                <img src="<?php echo get_theme_file_uri() . "/images/img_1.jpg" ?>" alt="Image" class="img-fluid">
            </div>
    ...
    <div class="container">
        <div class="row mb-5">
            <div class="col-lg-5 mx-auto text-center ">
                ...
                <p class="mb-4" data-aos="fade-up" data-aos-delay="100">Far far away, behind the word mountains, far
        ...
        <div id="post-slider" class="post-slider">
            ...
            <div class="item">
                <a href="case-study.html" class="card">
                    <img src="<?php echo get_theme_file_uri("/images/img-2.jpg") ?> " class=" card-img-top" alt="Image">
                    <div class="card-body">
                        <h5 class="card-title">Behind the word mountains</h5>
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia,
                            there live the blind texts. </p>
            ...
            <div class="item">
                <a href="case-study.html" class="card">
                    <img src="<?php echo get_theme_file_uri("/images/img-3.jpg") ?>" class=" card-img-top" alt="Image">
                    <div class="card-body">
                        <h5 class="card-title">Behind the word mountains</h5>
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia,
                            there live the blind texts. </p>
            ...
            <div class="item">
                <a href="case-study.html" class="card">
                    <img src="<?php echo get_theme_file_uri("/images/img-4.jpg") ?>" class=" card-img-top" alt="Image">
                    <div class="card-body">
                        <h5 class="card-title">Behind the word mountains</h5>
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia,
                            there live the blind texts. </p>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="card post-entry">
                    <a href="single.html"><img src="<?php echo get_theme_file_uri("/images/img-1.jpg")  ?>" class="card-img-top" alt="Image"></a>
                    <div class="card-body">
            ...
            <div class="col-lg-4">
                <div class="card post-entry">
                    <a href="single.html"><img src="<?php echo get_theme_file_uri("/images/img-2.jpg")  ?>" class="card-img-top" alt="Image"></a>
                    <div class="card-body">
                        <div><span class="text-uppercase font-weight-bold date">Jan 20, 2021</span></div>
                        <h5 class="card-title"><a href="single.html">Behind the word mountains</a></h5>
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia,
            ...
            <div class="col-lg-4">
                <div class="card post-entry">
                    <a href="single.html"><img src="<?php echo get_theme_file_uri("/images/img-3.jpg")  ?>" class="card-img-top" alt="Image"></a>
                    <div class="card-body">
                        <div><span class="text-uppercase font-weight-bold date">Jan 20, 2021</span></div>
                        <h5 class="card-title"><a href="single.html">Behind the word mountains</a></h5>
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia,
