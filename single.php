        ...
        <div class="row justify-content-center align-items-stretch">
            <div class="col-lg-8 order-lg-2 px-lg-5">
                ...
                <article>
                    ...
                    <img src="<?php echo get_theme_file_uri("/images/img_1.jpg") ?>" alt="Image" class="img-fluid rounded">
                    ...
                    <p>Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language
                        ocean.A
                        small river named Duden flows by their place and supplies it with the necessary regelialia.And
                        if
                    ...
                    <div class="pt-5">
                        ...
                        <ul class="comment-list">
                            <li class="comment">
                                <div class="vcard bio">
                                    <img src="<?php echo get_theme_file_uri("/images/person_1.jpg") ?>" alt="Image placeholder">
                                </div>
                            ...
                            <li class="comment">
                                <div class="vcard bio">
                                    <img src="<?php echo get_theme_file_uri("/images/person_2.jpg") ?>" alt="Image placeholder">
                                </div>
                                <div class="comment-body">
                                ...
                                <ul class="children">
                                    <li class="comment">
                                        <div class="vcard bio">
                                            <img src="<?php echo get_theme_file_uri("/images/person_3.jpg") ?>" alt="Image placeholder">
                                        </div>
                                        <div class="comment-body">
                                            <h3>Chintan Patel</h3>
                                            <div class="meta">January 9, 2018 at 2:21pm</div>
                                        ...
                                        <ul class="children">
                                            <li class="comment">
                                                <div class="vcard bio">
                                                    <img src="<?php echo get_theme_file_uri("/images/person_4.jpg") ?>" alt="Image placeholder">
                                                </div>
                                                <div class="comment-body">
                                                    <h3>John Doe</h3>
                                                    <div class="meta">January 9, 2018 at 2:21pm</div>
                                                ...
                                                <ul class="children">
                                                    <li class="comment">
                                                        <div class="vcard bio">
                                                            <img src="<?php echo get_theme_file_uri("/images/person_5.jpg") ?>" alt="Image placeholder">
                                                        </div>
                                                        <div class="comment-body">
                                                            <h3>Ben Afflick</h3>
                                                            <div class="meta">January 9, 2018 at 2:21pm</div>
